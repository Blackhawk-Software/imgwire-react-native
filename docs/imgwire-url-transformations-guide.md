...
- `@imgwire/js@0.3.1` and `@imgwire/react-native` accept the same canonical
...
| `progressive`         | `progressive`                                   | boolean or `auto`                                                                                                                                             | boolean or `auto`                                         |
| `quality`             | `q`, `quality`                                  | integer `1..100` or `auto`                                                                                                                                    | number or `auto`                                          |
